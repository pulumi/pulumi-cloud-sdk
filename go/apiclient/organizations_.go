...
func (p *CloudClient) AcceptOrgInvite(
	ctx context.Context,
	orgName string,
	inviteID string,
	extraHeaders ...http.Header,
	...
	if p.Interceptor != nil {
		argForInterceptor := InterceptorForAcceptOrgInvite{
			OrgName:      orgName,
			InviteID:     inviteID,
...
type InterceptorForAddServiceItemsV2 struct {
	OrgName      string
	OwnerType    string
	OwnerName    string
	ServiceName  string
...
func (p *CloudClient) AddServiceItemsV2(
	ctx context.Context,
	orgName string,
	ownerType string,
	ownerName string,
	...
	if p.Interceptor != nil {
		argForInterceptor := InterceptorForAddServiceItemsV2{
			OrgName:      orgName,
			OwnerType:    ownerType,
			OwnerName:    ownerName,
			ServiceName:  serviceName,
...
type InterceptorForCancelOrgInvite struct {
	OrgName      string
	InviteID     string
	ExtraHeaders []http.Header
}

func (p *CloudClient) CancelOrgInvite(
	ctx context.Context,
	orgName string,
	inviteID string,
	extraHeaders ...http.Header,
	...
	if p.Interceptor != nil {
		argForInterceptor := InterceptorForCancelOrgInvite{
			OrgName:      orgName,
			InviteID:     inviteID,
			ExtraHeaders: extraHeaders,
		}
...
type InterceptorForGetOrgInvite struct {
	OrgName      string
	InviteID     string
	ExtraHeaders []http.Header
}

func (p *CloudClient) GetOrgInvite(
	ctx context.Context,
	orgName string,
	inviteID string,
	extraHeaders ...http.Header,
...
type InterceptorForGetOrganizationMemberTeams struct {
	OrgName      string
	User         string
	ExtraHeaders []http.Header
}

func (p *CloudClient) GetOrganizationMemberTeams(
	ctx context.Context,
	orgName string,
	user string,
	extraHeaders ...http.Header,
...
func (p *CloudClient) GetProjectTemplate(
	...
	if p.Interceptor != nil {
		...
		if intercepted {
			...
			if !castFromInterceptor {
				return nil, fmt.Errorf("unexpected type returned from interceptor for GetProjectTemplate: %T", resultFromInterceptor)
			}
			return &typedResultFromInterceptor, nil
		}
	}
...
type InterceptorForListOrgInvites struct {
	OrgName      string
	ExtraHeaders []http.Header
}

func (p *CloudClient) ListOrgInvites(
	ctx context.Context,
	orgName string,
	extraHeaders ...http.Header,
...
type InterceptorForRemoveServiceItemV2 struct {
	OrgName      string
	OwnerType    string
	OwnerName    string
	ServiceName  string
...
func (p *CloudClient) RemoveServiceItemV2(
	ctx context.Context,
	orgName string,
	ownerType string,
	ownerName string,
	...
	if p.Interceptor != nil {
		argForInterceptor := InterceptorForRemoveServiceItemV2{
			OrgName:      orgName,
			OwnerType:    ownerType,
			OwnerName:    ownerName,
			ServiceName:  serviceName,
...
func (p *CloudClient) ResendOrgInvite(
	ctx context.Context,
	orgName string,
	inviteID string,
	request ext1.ResendOrganizationInviteRequest,
	...
	if p.Interceptor != nil {
		argForInterceptor := InterceptorForResendOrgInvite{
			OrgName:      orgName,
			InviteID:     inviteID,
			Request:      request,
			ExtraHeaders: extraHeaders,
