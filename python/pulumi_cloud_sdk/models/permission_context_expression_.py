...
class PermissionContextExpression(PermissionExpression):
    """
    """
    ...
    __DISCRIMINATOR_VALUE__ = "PermissionContextExpression"
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, PermissionContextExpression):
            pass

    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, PermissionContextExpression):
            return False
