...
class GraphFieldPredicateLt(GraphFieldPredicate):
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, GraphFieldPredicateLt):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GraphFieldPredicateLt):
            return False
