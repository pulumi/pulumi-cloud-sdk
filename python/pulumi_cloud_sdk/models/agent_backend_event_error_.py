...
class AgentBackendEventError(AgentBackendEvent):
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, AgentBackendEventError):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, AgentBackendEventError):
            return False
