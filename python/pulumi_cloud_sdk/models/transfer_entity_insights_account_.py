...
class TransferEntityInsightsAccount(TransferEntity):
    """
    ...
    __DISCRIMINATOR_VALUE__ = "TransferEntityInsightsAccount"
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, TransferEntityInsightsAccount):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, TransferEntityInsightsAccount):
            return False
