...
class AppInsightsAccountReference(PulumiAutoModelEncoder):
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        if isinstance(source, AppInsightsAccountReference):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, AppInsightsAccountReference):
            return False
