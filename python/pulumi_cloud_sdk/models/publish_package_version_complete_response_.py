...
class PublishPackageVersionCompleteResponse(PulumiAutoModelEncoder):
    """
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        if isinstance(source, PublishPackageVersionCompleteResponse):
            pass

    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, PublishPackageVersionCompleteResponse):
            return False
