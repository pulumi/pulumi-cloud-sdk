...
class GraphFieldPredicateLte(GraphFieldPredicate):
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, GraphFieldPredicateLte):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GraphFieldPredicateLte):
            return False
