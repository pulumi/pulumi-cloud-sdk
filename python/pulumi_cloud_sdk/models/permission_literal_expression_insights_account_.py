...
class PermissionLiteralExpressionInsightsAccount(PermissionLiteralExpression):
    """
    ...
    __DISCRIMINATOR_VALUE__ = "PermissionLiteralExpressionInsightsAccount"
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, PermissionLiteralExpressionInsightsAccount):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, PermissionLiteralExpressionInsightsAccount):
            return False
