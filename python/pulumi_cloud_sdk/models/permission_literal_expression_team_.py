...
class PermissionLiteralExpressionTeam(PermissionLiteralExpression):
    """
    ...
    __DISCRIMINATOR_VALUE__ = "PermissionLiteralExpressionTeam"
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, PermissionLiteralExpressionTeam):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, PermissionLiteralExpressionTeam):
            return False
