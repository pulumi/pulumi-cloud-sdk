...
class GraphFieldPredicateAbsent(GraphFieldPredicate):
    """
    """
    ...
    __DISCRIMINATOR_VALUE__ = "absent"
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, GraphFieldPredicateAbsent):
            pass

    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GraphFieldPredicateAbsent):
            return False
