...
class PublishTemplateVersionCompleteResponse(PulumiAutoModelEncoder):
    """
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        if isinstance(source, PublishTemplateVersionCompleteResponse):
            pass

    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, PublishTemplateVersionCompleteResponse):
            return False
