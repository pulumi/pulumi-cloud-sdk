...
class PermissionBooleanExpression(PermissionExpression):
    """
    """
    ...
    __DISCRIMINATOR_VALUE__ = "PermissionBooleanExpression"
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, PermissionBooleanExpression):
            pass

    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, PermissionBooleanExpression):
            return False
