...
class AppParameterizationDescriptorV1(PulumiAutoModelEncoder):
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        if isinstance(source, AppParameterizationDescriptorV1):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, AppParameterizationDescriptorV1):
            return False
