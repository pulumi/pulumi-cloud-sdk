...
class UpdateChangeRequestRequest(PulumiAutoModelEncoder):
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        if isinstance(source, UpdateChangeRequestRequest):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, UpdateChangeRequestRequest):
            return False
