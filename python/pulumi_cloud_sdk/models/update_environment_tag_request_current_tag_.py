...
class UpdateEnvironmentTagRequestCurrentTag(PulumiAutoModelEncoder):
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        if isinstance(source, UpdateEnvironmentTagRequestCurrentTag):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, UpdateEnvironmentTagRequestCurrentTag):
            return False
