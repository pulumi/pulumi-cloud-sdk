...
class AddCustomVCSRepositoryRequest(PulumiAutoModelEncoder):
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        if isinstance(source, AddCustomVCSRepositoryRequest):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, AddCustomVCSRepositoryRequest):
            return False
