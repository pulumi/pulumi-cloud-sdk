...
class GraphFieldPredicateEq(GraphFieldPredicate):
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, GraphFieldPredicateEq):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GraphFieldPredicateEq):
            return False
