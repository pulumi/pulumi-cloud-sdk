...
class GraphFieldPredicateGte(GraphFieldPredicate):
    """
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, GraphFieldPredicateGte):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GraphFieldPredicateGte):
            return False
