...
class GraphFieldPredicatePresent(GraphFieldPredicate):
    """
    """
    ...
    __DISCRIMINATOR_VALUE__ = "present"
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, GraphFieldPredicatePresent):
            pass

    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GraphFieldPredicatePresent):
            return False
