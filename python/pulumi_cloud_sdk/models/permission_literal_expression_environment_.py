...
class PermissionLiteralExpressionEnvironment(PermissionLiteralExpression):
    """
    ...
    __DISCRIMINATOR_VALUE__ = "PermissionLiteralExpressionEnvironment"
    ...
    def copy_common_fields(self, source: Any, /) -> None:
        ...
        if isinstance(source, PermissionLiteralExpressionEnvironment):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, PermissionLiteralExpressionEnvironment):
            return False
